            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  이 약관은 Re:cord(이하 "회사")가 제공하는 후기 자산 정리, 공개 신뢰 페이지 운영, 직접 후기 수집 및 관련 보조 서비스(이하 "서비스")의 이용과 관련하여 
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-700">
                  <li>"서비스"란 회사가 제공하는 후기 정리, 공개 신뢰 페이지 생성, 직접 후기 수집, 선택적 OCR 및 업로드 보조 등 일체의 서비스를 의미합니다.</li>
                  ...
                  <li>"프로필"이란 회원의 후기, 작업 이미지, 소개, 상담 링크 등을 모아 공개하는 신뢰 페이지를 의미합니다.</li>
                  <li>"제3자 플랫폼"이란 구글, 네이버, 카카오맵, 인스타그램 등 회원이 리뷰를 받은 외부 서비스를 의미합니다.</li>
                  <li>"OCR 서비스"란 회사가 선택적으로 제공할 수 있는 보조 기능으로, 이미지에서 텍스트를 자동으로 인식하여 후기 내용을 추출하는 기술을 의미합니다.</li>
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-700">
                  <li>회사는 다음과 같은 서비스를 제공합니다:
                    <ul className="list-disc pl-6 mt-2 space-y-1">
                      <li>제3자 플랫폼 리뷰 및 직접 후기의 정리, 보관, 관리 서비스</li>
                      <li>공개 신뢰 페이지 생성, 공개/비공개 제어, 공유 기능 제공</li>
                      <li>직접 후기 요청 링크 및 검토 흐름 제공</li>
                      <li>선택적 OCR, 이미지 업로드, 일괄 업로드 등 입력 보조 서비스</li>
                      <li>리뷰 진위성 검토, 신고 대응, 운영 지원 서비스</li>
                      <li>포트폴리오 공유 및 프로필 운영 도구 제공</li>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-700">
                  ...
                  <li>회사는 이용자의 신뢰성 있는 후기 자산 구축을 위해 후기 진위성 검토 및 신고 대응 시스템을 운영합니다.</li>
