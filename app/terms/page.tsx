            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-700">
                  ...
                  <li><strong>손해배상 한계:</strong>
                    <ul className="list-disc pl-6 mt-2 space-y-1">
                      <li>회사의 손해배상 책임은 고의 또는 중대한 과실이 있는 경우를 제외하고는 회원이 서비스 이용료로 회사에 지급한 금액을 초과하지 않습니다.</li>
                      <li>무료 서비스 이용자의 경우, 손해배상 한도는 100만원을 초과하지 않습니다.</li>
                      <li>간접손해, 특별손해, 결과적 손해, 징벌적 손해에 대해서는 책임을 지지 않습니다.</li>
                    </ul>
                  </li>
                </ol>
              </div>
