...
const hashtags = [
  ...
  "#배관_수리", "#도배_장판", "#페인트_시공",
  "#웹디자이너_프리랜서", "#그래픽디자인_포트폴리오", "#영상편집_유튜버",
  "#통역_번역가", "#작가_프리랜서", "#일러스트_작가",
  "#보컬코치_프리랜서", "#음치교정_전문", "#성악_입시지도"
]
