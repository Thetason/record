...
const hashtags = [
  ...
  "#피부관리_고객", "#네일아트_리뷰", "#반영구_시술리뷰",
  "#타투이스트_포트폴리오", "#퍼스널컬러_진단", "#스포츠마사지_회원",
  "#필라테스_독립", "#크로스핏_회원관리", "#카페사장_단골관리",
  "#베이커리_리뷰", "#플로리스트_포트폴리오", "#웨딩플래너_고객",
  "#포토그래퍼_리뷰", "#비즈니스_코칭", "#학원강사_수강생관리",
  "#과외선생님_후기", "#입시컨설턴트_합격률", "#영어회화_원어민",
  "#수학강사_성적향상", "#코딩강사_취업률", "#피아노선생님_레슨",
  "#성악_입시지도", "#작곡_레슨후기", "#기타레슨_입문자",
  "#드럼_전문강사", "#댄스_안무가", "#발레_전문지도",
  "#태권도_관장님", "#유도_선수출신", "#검도_사범님",
  "#수영강사_자격증", "#골프_레슨프로", "#테니스_코치",
  "#클라이밍_강사", "#서핑_레슨", "#스키_강습",
  "#요리_클래스", "#제과제빵_강사", "#바리스타_자격증",
  "#와인_소믈리에", "#칵테일_조주기능사", "#디저트_카페창업",
  "#반려동물_훈련사", "#펫시터_돌봄", "#애견미용_독립",
  "#청소_전문업체", "#에어컨_청소", "#이사_용역",
  "#인테리어_시공", "#목공_DIY강사", "#전기_설비",
  "#배관_수리", "#도배_장판", "#페인트_시공"
]
      ...
      <section className="py-16 overflow-hidden bg-white">
        ...
        <div className="relative overflow-hidden">
          <div className="flex gap-4 animate-scroll-left-to-right">
            {[...hashtags, ...hashtags, ...hashtags, ...hashtags, ...hashtags, ...hashtags].map((tag, i) => (
              <div
                key={i}
